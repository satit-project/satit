...
<head>
    ...
    <link href="../css/prenomina.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <section>
        <img src="../img/menu/nomina.png" class="img-logo">
        <h2>1208750</h2>
    </section>
    ...
    <div id="seccion-renglones">
        <script>
        var labels = ["Pago","Horas trabajadas"]
        creaRenglones(labels)</script>
    </div>

    <!--Boton continuar-->
        <a href="../html/menu.php"class="btn btn-continuar">Continuar</a>
    </div>
</body>
<!-- Barra inferior-->
<footer class="footer">
